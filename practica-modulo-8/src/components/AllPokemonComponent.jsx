    ...
    <>
        ...
        <h3 className='todosPokemons'>
          ...
          >
            ...
            >
              ...
              />
              <path strokeLinecap='round' d='M18 24H4C4 35.05 12.95 44 24 44C35.05 44 44 35.05 44 24H30' />
      ...
      />
        ...
        {pokemon.map((pokemon, index) => {
          return (
            <div className='divTodosPokemon' key={index}>
              <div className='divCadaPokemon'>
                ...
                <button onClick={() => addToFavorites(pokemon)} className='favoritos'>
                  Añadir a favoritos
                </button>
              </div>
            </div>
